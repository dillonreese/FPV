...
- [Blheli32](https://github.com/blheli-configurator/blheli-configurator/releases)
- [Blheli_S](https://github.com/bitdump/BLHeli)
- [Emuflight](https://github.com/emuflight/EmuConfigurator/releases)
- [Fettec ESC Configurator](https://github.com/FETtec/ESC-Configurator/releases)
- [ImpulseOSD Driver Fixer](https://impulserc.blob.core.windows.net/utilities/ImpulseRC_Driver_Fixer.exe)
- [ImpulseOSD](https://impulserc.com/pages/downloads)
    - [Mac](https://itunes.apple.com/us/app/impulseosd/id1416313087)
